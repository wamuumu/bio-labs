...
class Boid(Rules):
    ...
    def update(self, boids, ALIGNMENT, SEPARATION,COHESION):
        ...
        ### Rules to follow
        cohesian = ALIGNMENT * Rules.fly_towards_center(self, n)
        separation_from_boids = SEPARATION * Rules.keep_distance_away(self, n, 9)
        alignment = COHESION * Rules.match_velocity(self, n)

        # Update velocity 
        self.velocity += cohesian + separation_from_boids + alignment
